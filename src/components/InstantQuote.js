...
export default function InstantQuote({ openQuote, onCloseQuote }) {
  ...
  return (
    <div className={`modal ${openQuote? 'is-active':''}`}>
      <div className="modal-background" onClick={onCloseQuote}></div>
      <button className="modal-close is-large" aria-label="close" onClick={onCloseQuote}></button>
      <div className="modal-content">
        <h1 className="center"> Instant Quote</h1>
